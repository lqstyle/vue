...
var historyModelId = getQueryString('historyId');
...
var customActivityColors = getQueryString('color-mapping');
...
var customActivityToolTips = getQueryString('activity-tooltips');
...
var customActivityBackgroundOpacity = getQueryString('activity-opacity');
...
if (modelType == 'runtime') {
  if (historyModelId) {
    modelUrl = ServerUrl+'/diagram/process-instances/history/' + historyModelId + '/model-json';
  } else {
    modelUrl = ServerUrl+'/diagram/process-instances/' + modelId + '/model-json';
  }
} else if (modelType == 'design') {
  if (historyModelId) {
    modelUrl = ServerUrl+'/diagram/models/' + modelId + '/history/' + historyModelId + '/model-json';
  } else {
    modelUrl = ServerUrl+'/diagram/models/' + modelId + '/model-json';
  }
} else if (modelType == 'process-definition') {
  modelUrl = ServerUrl+'/diagram/process-definitions/' + processDefinitionId + '/model-json';
}
...
request.success(function (data, textStatus, jqXHR) {
  ...
  parent.document.getElementById('dialogDiagramIframe').style.width=INITIAL_CANVAS_WIDTH+'px';
  parent.document.getElementById('dialogDiagramIframe').style.height=INITIAL_CANVAS_HEIGHT+'px';
