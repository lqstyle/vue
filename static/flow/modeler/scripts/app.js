...
flowableModeler
  // Initialize routes
  .config(['$provide','$httpProvider', '$routeProvider', '$selectProvider', '$translateProvider', function ($provide, $httpProvider, $routeProvider, $selectProvider, $translateProvider) {
