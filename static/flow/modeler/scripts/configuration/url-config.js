...
FLOWABLE.APP_URL = {
    ...
    getAccountUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/v1/account';
    },
    ...
    getModelBpmn20ExportUrl: function (modelId) {
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/models/' + modelId + '/bpmn20?version=' + Date.now() + '&token=' + window.token;
    },
    ...
    getModelHistoryBpmn20ExportUrl: function (modelId, modelHistoryId) {
        return FLOWABLE.CONFIG.contextRoot + '/app/rest/models/' + modelId + '/history/' + modelHistoryId + '/bpmn20?version=' + Date.now() + '&token=' + window.token;
    },
