    ...
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q) {
		...
		$scope.deleteDeployment = function() {
            ...
            modalInstance.result.then(function (result) {
                if (result === true) {
                    $http({method: 'DELETE', url: FLOWABLE.CONFIG.contextRoot+'/app/rest/admin/form-deployments/' + $routeParams.deploymentId}).
		...
		$scope.executeWhenReady(function() {
		    // Load deployment
		    $http({method: 'GET', url: FLOWABLE.CONFIG.contextRoot+'/app/rest/admin/form-deployments/' + $routeParams.formDeploymentId}).
  	    	    success(function(data, status, headers, config) {
		    ...
		    $http({method: 'GET', url: FLOWABLE.CONFIG.contextRoot+'/app/rest/admin/form-definitions?deploymentId=' + $routeParams.formDeploymentId}).
  	    	    success(function(data, status, headers, config) {
